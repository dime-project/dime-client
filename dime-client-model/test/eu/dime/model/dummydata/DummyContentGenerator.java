...
public class DummyContentGenerator {
    ...
    private static String[] randomFileNames = {"bike.jpg", "black_lodge.jpg", "calculation.xlsx", "cat.JPG", "hannover_fair.JPG", "project_pitch.docx"};
    ...
    private static String[] randomPlaceAddresses = {"Agra, Uttar Pradesh 282001, India", "Presidio, San Francisco, CA, USA", "Uluru Northern Territory 0872"};
    ...
    private static void generateRandomSituations(ModelRequestContext mrContext, int num) {
...
//            }
    ...
    private static void generateRandomPlaces(ModelRequestContext mrContext, int num) {
    ...
    private static void generateRandomDataBoxes(ModelRequestContext mrContext, int num) {
    ...
    private static void generateRandomResources(ModelRequestContext mrContext, int num, boolean createForeign) {
    ...
    private static void generateRandomLivepost(ModelRequestContext mrContext, int num, boolean createForeign) {
    ...
    private static void generateOneNCOProfile(ModelRequestContext mrContext) {
    ...
    private static void generateOneNCOProfileAtt(ModelRequestContext mrContext) {
    ...
    private static void generateRandomProfileAttributes(ModelRequestContext mrContext, int num) {
        TYPES type = TYPES.PROFILEATTRIBUTE;
        Random rnd = new Random();
        class InnerProfileAttributeItem {
            String category;
    ...
    private static void generateRandomProfiles(ModelRequestContext mrContext, int num, boolean createForeign) {
        TYPES type = TYPES.PROFILE;
        Random rnd = new Random();
        List<String> userGUIDs = getExistingGUIDs(mrContext, TYPES.PERSON);
        for (int i = 0; i < num; i++) {
    ...
    private static void generateRandomGroups(ModelRequestContext mrContext, int num) {
    ...
    private static void generateRandomPeople(ModelRequestContext mrContext, int num) {
    ...
    private static DisplayableItem generateRandomItem(ModelRequestContext mrContext, TYPES type) {
    ...
    private static DisplayableItem assignRandomExistingChildren(ModelRequestContext mrContext, TYPES type, DisplayableItem item, int minChildren, int maxChildren) {
        Random rnd = new Random();
